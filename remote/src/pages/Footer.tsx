    ...
    <footer className="border-t bg-gray-900 text-gray-300">
      <div className="mx-auto container  px-6 py-12">
        <div className="grid gap-10 md:grid-cols-4">
          <div>
            ...
            <p className="mt-4 max-w-xs text-sm leading-6 text-gray-400">
              A simple and powerful platform to manage your employees, products,
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm">
              ...
              <li>
                <a href="/posts" className="transition-colors hover:text-white">
                  Posts
                </a>
              </li>
        ...
        <div className="mt-10 flex flex-col gap-4 border-t border-gray-700 pt-6 text-sm text-gray-400 md:flex-row md:items-center md:justify-between">
          <p>© {new Date().getFullYear()} ProjectApp. All rights reserved.</p>
